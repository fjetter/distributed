...
class Occupancy(DashboardComponent):
    ...
    def update(self):
        ...
        occupancy_cpu = []
        for ws in workers:
            total_occ = ws.occupancy
            network_occ = ws._network_occ / self.scheduler.bandwidth
            occupancy_network.append(network_occ)
            occupancy_cpu.append(max(0, total_occ - network_occ))
