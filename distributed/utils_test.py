...
async def _dump_cluster_state(client, directory):
    ...
    def get_worker_info(dask_worker):
        # TODO: Replace with a Worker.to_dict or smth similar
        import dask
    ...
    def get_scheduler_info(dask_scheduler):
        # TODO: Replace with a Scheduler.to_dict or smth similar
        import dask
    ...
    # msgpack and gzip is overkill for tests but it is often necessary for real
    # world examples
    import gzip
